...
MODELS: dict[str, ModelEntry] = {
    ...
    "surrogate_cu_inj": ModelEntry(
        ...
        description="LCLS CU injector (NN surrogate)",
        facility="lcls",
        simulator="surrogate",
        builder=(
    ...
    "cheetah_cu_hxr": ModelEntry(
        name="cheetah_cu_hxr",
        description="LCLS CU-HXR full beamline",
        facility="lcls",
        simulator="cheetah",
    ...
    "surrogate_f2e_inj": ModelEntry(
        ...
        description="FACET-II injector (NN surrogate)",
        facility="facet2",
        simulator="surrogate",
